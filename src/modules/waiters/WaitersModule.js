...
export default function WaitersModule() {
  return (
    <Routes>
      ...
      <Route path="/waiter/:waiterId/Menu" element={<MenuPage />}></Route>
      <Route path="/waiter/:waiterId/AllTable" element={<AllTablesPage />}></Route>
      <Route path="/waiter/:waiterId/MyTable/1" element={<MyTablesPage />}></Route>
    </Routes>
  );
}
